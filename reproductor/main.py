...
class Sistema:
    def __init__(self):
        self.ruta_descargas="{}\\descargas".format(getcwd())
        self.ruta_reproducir="{}\\reproducir".format(getcwd())
            ...
            while True:
                if subp_repr.is_alive() == True: # SI EL SUBPROCESO DE REPRODUCCION SIGUE EJECUTANDOSE
                    if self.siguiente==True:
                        break # SI SE PRESIONÓ EL BOTON DE SIGUIENTE ROMPER BUCLE
                    elif self.parar==True:
